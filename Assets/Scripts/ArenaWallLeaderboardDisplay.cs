...
public class ArenaWallLeaderboardDisplay : MonoBehaviour
{
    ...
    [Tooltip("是否显示背后的黑板？")]
    [SerializeField] private bool showBackgroundBoard = true;
    [Tooltip("拖入烘焙好的 TextMeshPro 微软雅黑字体资产")]
    ...
    [SerializeField]
    private List<EntryData> seedEntries = new List<EntryData>
    {
    ...
    private void EnsureBuilt()
    {
        ...
        // 传入 customFont 参数
        titleLabel = CreateTextLabel(canvasObject.transform, "Title", new Vector2(0f, -92f), new Vector2(920f, 92f), 66f, TextAlignmentOptions.Center, customFont);
        titleLabel.fontStyle = FontStyles.Bold | FontStyles.UpperCase;
        titleLabel.color = titleColor;
        titleLabel.characterSpacing = 18f;

        subtitleLabel = CreateTextLabel(canvasObject.transform, "Subtitle", new Vector2(0f, -156f), new Vector2(920f, 40f), 24f, TextAlignmentOptions.Center, customFont);
        ...
        {
            TextMeshProUGUI rowLabel = CreateTextLabel(canvasObject.transform, $"Row {i + 1}", new Vector2(0f, -258f - i * 76f), new Vector2(960f, 52f), 36f, TextAlignmentOptions.Left, customFont);
    ...
    private void RefreshVisuals()
    {
        ...
        {
            // 核心修改：开关背景板
            boardRenderer.enabled = showBackgroundBoard;
    ...
    // 接收 customFont 参数，并赋予字体
    private static TextMeshProUGUI CreateTextLabel(Transform parent, string name, Vector2 anchoredPosition, Vector2 size, float fontSize, TextAlignmentOptions alignment, TMP_FontAsset fontAsset)
    {
